...
//        dispatcher.schedule(myJob);
    ...
    private void sendNotification(String messageBody) {
        try {
            ...
            Intent intent;
            if (jsonArray.getJSONObject("PushType") != null)
                if (jsonArray.getJSONObject("PushType").equals("request"))
                    intent = new Intent(this, RequestsActivity.class);
                else intent = new Intent(this, TagActivity.class);
            else intent = new Intent(this, TagActivity.class);
            ...
            NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                    ...
                    .setContentTitle(jsonArray.getJSONObject("name").toString())
                    .setContentText("Send you a request!")
                    .setAutoCancel(true)
